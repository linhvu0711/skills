...
- License: Apache-2.0
- Commit: `091cf945e41966aaadef4b4435f41e15ec413d6d` (best match of the first copy)

| Skill or file | Upstream path | Level |
|---|---|---|
| `skills/create-pr` | `.agents/skills/create-pull-request` | copy |

`skills/create-pr/SKILL.md` was changed: the skill is renamed `create-pr`, the title is "Create PR", and the "Add labels if needed" step is dropped. Upstream has no `NOTICE` file.
