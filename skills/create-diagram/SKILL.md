...
4. When the project has a design system (tokens, theme file, `AGENTS.md` or `CLAUDE.md`), move the shell's `:root` tokens onto it; otherwise keep the shell unchanged. Use `impeccable` only when adapting the visual design.
