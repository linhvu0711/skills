...
Only generates the commit message. Does not run `git commit`, does not stage files, does not amend. Output the message as a code block ready to paste. "stop git-commit" or "normal mode": revert to verbose commit style.
